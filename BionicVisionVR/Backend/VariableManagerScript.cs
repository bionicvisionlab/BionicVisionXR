...
public class VariableManagerScript : MonoBehaviour { 
    ...
    public PreDefinedSettings predefinedSettings;
    private PreDefinedSettings lastUsedPredefSettings;
    ...
    public void UpdateConfig()
    {
        ...
        {
            SimulationSettings c_block = SimulationSettings.GetPreDefinedSimulationSettings(predefinedSettings);
    ...
    public void UpdateConfig(PreDefinedSettings newSetting)
    {
