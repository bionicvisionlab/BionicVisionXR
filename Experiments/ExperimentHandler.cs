...
namespace BionicVisionVR.Coding.Resources
{
    ...
    public class ExperimentHandler : MonoBehaviour
    {
        ...
        public int ConvertBlockTrialToSingleDimension(int block, int trial)
        {
            return block * numberOfTrials + trial; 
        }

        public (int, int) ConvertBlockTrialFromSingleDimension(int blockTrial)
        {
            return (blockTrial / numberOfTrials, blockTrial % numberOfTrials); 
        }

        public int GetBlockTrialSingleDimension()
        {
            return ConvertBlockTrialToSingleDimension(currentBlock, currentTrial); 
        }
