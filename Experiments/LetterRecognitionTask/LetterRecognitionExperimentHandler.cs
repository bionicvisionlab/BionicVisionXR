...
public class LetterRecognitionExperimentHandler : MonoBehaviour
{
    ...
    public PreDefinedSettings[] blockSettings = new PreDefinedSettings[] {PreDefinedSettings.LetterTask1, PreDefinedSettings.LetterTask5, PreDefinedSettings.LetterTask9};
